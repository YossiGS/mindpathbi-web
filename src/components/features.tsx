...
const features = [
  ...
  },
  {
    ...
    description:
      "Upload product specs, sizing rules, installation guides, or any domain expertise. The AI Copilot pulls the right answer instantly — turning every rep into a subject-matter expert.",
    color: "#64d2ff",
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    title: "Smart Routing",
    description:
      "SLA timers, auto-assignment rules, escalation paths, working hours, and auto-reply — so every message reaches the right person at the right time.",
    color: "#ffd60a",
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "The AI learns your categories from real data — no fixed taxonomy. Threads get labeled, routed, and archived automatically as patterns emerge.",
    color: "#ac8e68",
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "Pre-built replies with smart variables. Or describe what you need in plain English and the AI Builder writes the template for you.",
    color: "#30d158",
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "Event-driven workflows with AI steps, conditions, delays, and actions. Automate routing, escalations, and follow-ups without code.",
    color: "#ff375f",
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    title: "Global Search",
    description:
      "Cmd+K across contacts, messages, deals, and tasks. Find anything in seconds with grouped results and keyboard navigation.",
    color: "#86868b",
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
